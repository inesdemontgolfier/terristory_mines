...
consultations_themes_equipements(regions=['auvergne-rhone-alpes'], titre_figure = "figures/consultation_equipements_v1")

#Représente la proportion des consultations de chaque équipement dans la région auvergne-rhone-alpes
consultations_equipements(regions=['auvergne-rhone-alpes'], titre_figure = "figures/consultation_equipements_v2")
...
consultations_themes_equipements(titre_figure = "figures/consultation_equipements_v3")

#Représente la proportion des consultations de chaque équipement dans toutes les régions répertoriées dans Terristory
consultations_equipements(titre_figure = "figures/consultation_equipements_v4")